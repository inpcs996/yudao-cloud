...
public class OaOfficialDocReceiveServiceImplTest extends BaseDbUnitTest {
    ...
    public void testSubmitOfficialDocReceive_manual() {
        ...
        officialDocReceiveMapper.insert(receive);
        // mock 方法
        when(processInstanceApi.createProcessInstance(eq(1L), any())).thenReturn(success("manual-process"));
    ...
    public void testClaimOfficialDocReceive() {
        ...
        officialDocReceiveMapper.insert(receive);
        // mock 方法
        when(adminUserApi.getUser(1L)).thenReturn(success(new AdminUserRespDTO().setDeptId(10L)));
    ...
    public void testClaimOfficialDocReceive_otherDept() {
        ...
        officialDocReceiveMapper.insert(receive);
        // mock 方法
        when(adminUserApi.getUser(2L)).thenReturn(success(new AdminUserRespDTO().setDeptId(20L)));
    ...
    public void testSubmitOfficialDocReceive() {
        ...
        officialDocReceiveMapper.insert(receive);
        // mock 方法
        when(processInstanceApi.createProcessInstance(eq(1L), any())).thenReturn(success("receive-process"));
    ...
    public void testGetOfficialDocReceivePage_noDept() {
        // mock 方法
        when(adminUserApi.getUser(1L)).thenReturn(success(new AdminUserRespDTO()));
    ...
    public void testSubmitOfficialDocReceive_afterHandlerChanged() {
        ...
        officialDocReceiveMapper.insert(receive);
        // mock 方法
        when(processInstanceApi.createProcessInstance(eq(1L), any())).thenReturn(success("creator-process"));
