...
public class OaTravelReimbursementServiceImplTest extends BaseDbUnitTest {
    ...
    public void setUpCloudApiMocks() {
        ...
        lenient().when(dictDataApi.validateDictDataList(anyString(), anyCollection())).thenReturn(success(true));
    ...
    public void testSubmitTravelReimbursement_savedContentAndAssignees() {
        ...
        // mock 方法
        when(processInstanceApi.createProcessInstance(eq(10L), any())).thenReturn(success("new-process"));
    ...
    public void testCreateTravelReimbursement_invalidExpenseType() {
        ...
        // mock 方法
        when(dictDataApi.getDictDataList(anyString())).thenReturn(success(Collections.emptyList()));
