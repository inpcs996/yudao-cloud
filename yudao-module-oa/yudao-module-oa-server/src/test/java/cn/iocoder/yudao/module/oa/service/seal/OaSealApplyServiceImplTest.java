...
public class OaSealApplyServiceImplTest extends BaseDbUnitTest {
    ...
    public void setUpCloudApiMocks() {
        ...
        lenient().when(processInstanceApi.cancelProcessInstanceByStartUser(anyLong(), anyString(), anyString())).thenReturn(success(true));
    }
    ...
    public void testCreateSealApply() {
        ...
        when(adminUserApi.getUser(10L)).thenReturn(success(new AdminUserRespDTO().setId(10L).setDeptId(20L)));
    ...
    public void testSubmitSealApply_autoApprove() {
        ...
        when(processInstanceApi.createProcessInstance(eq(10L), any())).thenAnswer(invocation -> {
            ...
            return success("seal-auto-process");
        });
    ...
    public void testSubmitSealApply_inactiveApplicationDoesNotOccupy(int status) {
        ...
        // mock 方法
        when(sealService.validateSealExists(30L)).thenReturn(randomSealDO());
        when(processInstanceApi.createProcessInstance(eq(10L), any())).thenReturn(success("no-conflict"));
    ...
    public void testSubmitSealApply_overdueDoesNotExtendExpectedPeriod() {
        ...
        // mock 方法
        when(sealService.validateSealExists(30L)).thenReturn(randomSealDO());
        when(processInstanceApi.createProcessInstance(eq(10L), any())).thenReturn(success("p1"));
    ...
    public void testSubmitSealApply_onsiteDoesNotOccupy() {
        ...
        // mock 方法
        when(sealService.validateSealExists(30L)).thenReturn(randomSealDO());
        when(processInstanceApi.createProcessInstance(eq(10L), any())).thenReturn(success("onsite"));
    ...
    public void testSubmitSealApply_pastTime() {
        ...
        // mock 方法
        when(sealService.validateSealExists(30L)).thenReturn(randomSealDO());
        when(processInstanceApi.createProcessInstance(eq(10L), any())).thenReturn(success("past"));
    ...
    public void testSubmitSealApply_approvedPendingOutsidePeriod() {
        ...
        // mock 方法
        when(sealService.validateSealExists(30L)).thenReturn(randomSealDO());
        when(processInstanceApi.createProcessInstance(eq(10L), any())).thenReturn(success("outside"));
    ...
    public void testSubmitSealApply_refreshSealSnapshot() {
        ...
        when(processInstanceApi.createProcessInstance(eq(10L), any())).thenReturn(success("seal-snapshot-process"));
