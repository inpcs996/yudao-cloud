...
public class OaWorkReportServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetWorkReport_managerCannotReadDraft() {
        ...
        workReportMapper.insert(report);
        // mock 方法
        when(adminUserApi.getUserListBySubordinate(2L)).thenReturn(success(Collections.singletonList(
                new AdminUserRespDTO().setId(1L))));
        when(permissionApi.hasAnyPermissions(2L, "oa:work-report:statistics")).thenReturn(success(true));
    ...
    public void testGetWorkReportStatistics_partialWeekAndZeroReports() {
        ...
        // mock 方法
        when(adminUserApi.getUserListBySubordinate(9L)).thenReturn(success(Arrays.asList(
    ...
    public void testGetWorkReportStatistics_partialMonthAndCancelled() {
        ...
        // mock 方法
        when(adminUserApi.getUserListBySubordinate(9L)).thenReturn(success(Collections.singletonList(
                new AdminUserRespDTO().setId(1L).setDeptId(10L).setStatus(0))));
        when(deptApi.getDeptMap(anyCollection())).thenReturn(Collections.emptyMap());
    ...
    public void testGetWorkReportStatistics_deptScope() {
        ...
        // mock 方法
        when(deptApi.getChildDeptList(10L)).thenReturn(success(Collections.singletonList(new DeptRespDTO().setId(11L))));
        when(adminUserApi.getUserListBySubordinate(9L)).thenReturn(success(Arrays.asList(
